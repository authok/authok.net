namespace Authok.AuthenticationApi.Models
{
    ...
    public class ResourceOwnerTokenRequest
    {
        ...
        /// </summary>
        /// <remarks>
        /// See https://authok.cn/docs/api-auth/grant/password#realm-support for more details.
        /// </remarks>
        ...
        /// See https://authok.cn/docs/api-auth/tutorials/using-resource-owner-password-from-server-side for more details.
        /// </remarks>
