...
{
    /// <summary>
    /// Client for communicating with the Authok Authentication API.
    /// </summary>
    /// <remarks>
    /// Full documentation for the Authentication API is available at https://authok.cn/docs/auth-api
    /// </remarks>
    public interface IAuthenticationApiClient
    {
        ...
        /// <remarks>This feature has been deprecated and will be removed from Authok and this library in a future release.</remarks>
        ...
        /// then the grant_type will be set to "password". If a Realm was specified, then the grant_type will be set to "http://authok.cn/oauth/grant-type/password-realm"
        /// </remarks>
