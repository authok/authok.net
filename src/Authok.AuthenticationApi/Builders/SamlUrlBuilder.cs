...
namespace Authok.AuthenticationApi.Builders
{
    /// <summary>
    /// Builder class used to fluently construct a SAML authorization URL.
    /// </summary>
    /// <remarks>
    /// See https://authok.cn/docs/api/authentication#accept-request for more details.
    /// </remarks>
    public class SamlUrlBuilder : UrlBuilderBase<SamlUrlBuilder>
    {
        ...
        /// <returns>Current <see cref="SamlUrlBuilder"/> to allow fluent configuration.</returns>
        /// <remarks>
        /// See https://authok.cn/docs/protocols/saml/saml-configuration/special-configuration-scenarios/idp-initiated-sso#authok-as-identity-provider-where-idp-initiates-sso for more details on RelayState.
        /// </remarks>
        public SamlUrlBuilder WithRelayState(string value)
        {
            // This parameter must use PascalCase (i.e. RelayState) see https://github.com/authok/authok.net/issues/186 
