...
namespace Authok.ManagementApi
{
    ...
    public class ManagementApiClient : IManagementApiClient
    {
        ...
        /// </summary>
        /// <param name="token">A valid Authok Management API v2 token.</param>
        ...
        /// </summary>
        /// <param name="token">A valid Authok Management API v2 token.</param>
        /// <param name="domain">Your Authok domain. <example>tenant.authok.cn</example></param>
        ...
        private static Dictionary<string, string> CreateDefaultHeaders(string token)
        {
            var headers = new Dictionary<string, string> {
                { "Authok-Client", CreateAgentString() } };
        ...
        /// </summary>
        /// <param name="token">The new and valid Authok Management API v2 token.</param>
