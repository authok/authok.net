...
namespace Authok.ManagementApi.Models
{
    ...
    public abstract class ClientBase
    {
        ...
        /// <summary>
        /// The URLs that Authok can redirect to after logout
        /// </summary>
        ...
        /// <summary>
        /// A set of URLs that are valid to call back from Authok when authenticating users.
        /// </summary>
        ...
        /// <summary>
        /// True to use Authok instead of the IdP to do Single Sign On, false otherwise.
        /// </summary>
        [JsonProperty("sso")]
