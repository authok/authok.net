...
namespace Authok.ManagementApi.Models
{
    ...
    public class User : UserBase
    {
        ...
        /// <summary>
        /// Contains a lists of all the extra provider specific user attributes over and above those contained in the <a href="https://authok.cn/docs/user-profile/normalized">normalized user profile</a>.
        /// </summary>
        [JsonExtensionData]
