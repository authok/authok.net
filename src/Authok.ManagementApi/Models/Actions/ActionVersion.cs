...
{
    /// <summary>
    /// Represents a version for an action in Authok
    /// </summary>
    public class ActionVersion
    {
        ...
        /// <summary>
        /// The time when a version was updated. Versions are never updated externally. Only Authok will update an action version as it is being built.
        /// </summary>
