...
namespace Authok.ManagementApi.Models
{
    ...
    public enum EmailTemplateName
    {
        ...
        /// <summary>
        /// This email will be sent whenever Authok detects that the user is trying to access the application using a password that has been leaked by a third party. 
        /// </summary>
