...
namespace Authok.ManagementApi.Models
{
    ...
    public class TenantFlags
    {
        ...
        /// <summary>
        /// Whether emails sent by Authok for change password, verification etc. should use your verified custom domain (true) or your authok.cn sub-domain (false). Affects all emails, links, and URLs. Email will fail if the custom domain is not verified.
        /// </summary>
