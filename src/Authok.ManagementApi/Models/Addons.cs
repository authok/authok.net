...
namespace Authok.ManagementApi.Models
{
    ...
    /// <summary>
    /// Addons are extensions associated with an Application in Authok. Usually, they are 3rd party APIs used by the app that Authok generates access tokens for 
