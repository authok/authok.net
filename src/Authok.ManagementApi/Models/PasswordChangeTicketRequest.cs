...
namespace Authok.ManagementApi.Models
{
    ...
    public class PasswordChangeTicketRequest
    {
        ...
        /// If not specified or if you send 0 the Authok default lifetime will be applied
        /// </summary>
        ...
        /// See <see href="https://authok.cn/docs/universal-login/configure-default-login-routes">Configuring Default Login Routes</see> for more details.
        /// </summary>
