...
namespace Authok.AuthenticationApi.IntegrationTests
{
    public class HttpClientAuthenticationConnectionTests : TestBase
    {
        ...
        public async Task Disposes_HttpClient_it_creates_on_dispose()
        {
            ...
            connection.Dispose();
            await Assert.ThrowsAsync<ObjectDisposedException >(() => connection.GetAsync<string>(new Uri("https://www.authok.cn")));
        }
        ...
        public async Task Does_not_dispose_HttpClient_it_was_given_on_dispose()
        {
            ...
            await httpClient.GetAsync(new Uri("https://www.authok.cn"));
        }
    }
}
