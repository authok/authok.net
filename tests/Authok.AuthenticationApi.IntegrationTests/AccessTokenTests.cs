    ...
    public class AccessTokenTests : ManagementTestBase, IAsyncLifetime
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            _connection = await ApiClient.Connections.CreateAsync(new ConnectionCreateRequest
            {
                ...
                Strategy = "authok",
                EnabledClients = new[] { GetVariable("AUTHOK_CLIENT_ID"), GetVariable("AUTHOK_MANAGEMENT_API_CLIENT_ID") }
            });
            ...
            _authenticationApiClient = new TestAuthenticationApiClient(GetVariable("AUTHOK_AUTHENTICATION_API_URL"));
        }
        ...
        //{
        //    var authenticationApiClient = new TestAuthenticationApiClient(GetVariable("AUTHOK_AUTHENTICATION_API_URL"));
